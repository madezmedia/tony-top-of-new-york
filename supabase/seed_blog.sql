...
INSERT INTO public.posts (slug, title, excerpt, content, category, featured_image, published)
VALUES 
(
    ...
    'Casting',
    '/images/news/casting-call-nc.png',
    true
),
(
    ...
    'Production',
    '/images/news/episodes-in-production.png',
    true
),
(
