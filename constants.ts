...
export const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    date: 'March 15, 2026',
    category: 'Casting',
    imageUrl: buildImageUrl('press', 'text/tony_press_03', 'card'),
  },
  {
    id: 'n2',
    ...
    date: 'March 12, 2026',
    category: 'Production',
    imageUrl: buildImageUrl('bts', 'tony_bts_01', 'card'),
  },
  {
    id: 'n3',
    ...
    date: 'March 10, 2026',
    category: 'Platform',
    imageUrl: buildImageUrl('press', 'magazine/tony_magazine_02', 'card'),
  },
];
...
export const PRESS_ASSETS: PressAsset[] = [
  // Photos
  {
    ...
    thumbnailUrl: buildImageUrl('cast', 'tony_cast_29', 'card'),
  ...
  },
  {
    ...
    thumbnailUrl: buildImageUrl('press', 'posters/tony_poster_01', 'card'),
  ...
  },
  {
    ...
    thumbnailUrl: buildImageUrl('bts', 'tony_bts_01', 'card'),
  ...
  },
  {
    ...
    thumbnailUrl: buildImageUrl('gallery', 'tony_gallery_10', 'card'),
  ...
  // Magazine Covers
  {
    ...
    thumbnailUrl: buildImageUrl('press', 'magazine/tony_magazine_01', 'card'),
    downloadUrl: '#',
    fileSize: '8 MB',
    format: 'JPEG',
  },
  {
    ...
    thumbnailUrl: buildImageUrl('press', 'magazine/tony_magazine_02', 'card'),
    downloadUrl: '#',
    fileSize: '12 MB',
    format: 'JPEG',
  },
  // Videos
  {
    ...
    thumbnailUrl: buildImageUrl('gallery', 'tony_gallery_13', 'card'),
  ...
  // Documents
  {
    ...
    thumbnailUrl: buildImageUrl('press', 'text/tony_press_04', 'card'),
  ...
  },
  {
    ...
    thumbnailUrl: buildImageUrl('press', 'text/tony_press_05', 'card'),
...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  ...Array.from({ length: 24 }, (_, i) => ({
    id: `tony_gallery_${String(i + 1).padStart(2, '0')}`,
    title: `Bronx Scene Still ${i + 1}`,
    caption: 'Exclusive behind-the-scenes look at the production of T.O.N.Y.',
    imageUrl: buildImageUrl('gallery', `tony_gallery_${String(i + 1).padStart(2, '0')}`, 'card'),
  })).filter(img => img.id !== 'tony_gallery_11' && img.id !== 'tony_gallery_12'),
];
