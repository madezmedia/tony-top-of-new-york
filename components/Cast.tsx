...
import { ENHANCED_CAST } from '../constants';
...
export const Cast: React.FC = () => {
  ...
  // Get featured cast members for the grid
        ...
        {featuredCast.map((member) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6">
              ...
              >
                <p className="text-primary-main font-bold text-sm tracking-widest uppercase mb-1 drop-shadow-md">
                ...
                <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out">
                   <div className="min-h-0 overflow-hidden">
                      <p className="text-neutral-textSecondary text-sm leading-relaxed pt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                        {member.bio || `Bringing depth and authenticity to the role of ${member.characterName}.`}
                      </p>
             ...
             >
                ...
                <div className="md:w-7/12 p-8 md:p-12 overflow-y-auto custom-scrollbar">
                   ...
                   <div className="space-y-6 text-neutral-text text-lg leading-relaxed font-light">
                     <p>{selectedMember.bio || `Bringing a raw intensity to the role of ${selectedMember.characterName}.`}</p>
                     <p>
                       Bringing a raw intensity to the role, {selectedMember.actorName.split(' ')[0]} captures the essence of a character caught between two worlds.
                   ...
                   <div className="mt-10 pt-8 border-t border-neutral-border/50">
                      ...
                      <div className="flex gap-4">
                        <button type="button" aria-label="Follow on Instagram" className="w-12 h-12 rounded-full bg-neutral-bg border border-neutral-border flex items-center justify-center text-neutral-textSecondary hover:border-primary-main hover:text-primary-main hover:scale-110 transition-all">
                          <Instagram size={20} />
                        </button>
                        <button type="button" aria-label="Follow on Twitter" className="w-12 h-12 rounded-full bg-neutral-bg border border-neutral-border flex items-center justify-center text-neutral-textSecondary hover:border-primary-main hover:text-primary-main hover:scale-110 transition-all">
                          <Twitter size={20} />
                        </button>
                        <button type="button" aria-label="Visit website" className="w-12 h-12 rounded-full bg-neutral-bg border border-neutral-border flex items-center justify-center text-neutral-textSecondary hover:border-primary-main hover:text-primary-main hover:scale-110 transition-all">
                          <Globe size={20} />
                        </button>
                      </div>
                   </div>
